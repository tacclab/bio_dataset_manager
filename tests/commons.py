...
class TestDatasetFiles:
    ...
    dna_test_dataset_file = "./bio_test_samples/dna/dna_test_sequences.fna"
    ...
    protein_test_dataset_file = "./bio_test_samples/protein/protein_test_sequences.fna"
    ...
    smiles_test_dataset_file = "./bio_test_samples/smiles/smiles_test_sequences.fna"
